...
'Area': 'Area',
'Area de Ticket': 'Area de Ticket',
'Area de tickets': 'Area de tickets',
'Area do Ticket': 'Area do Ticket',
'Auth memberships': 'Membro do Grupo',
...
'Cadastro': 'Cadastro',
'Cadastro de permissões': 'Cadastro de permissões',
'Cadastro de Usuarios': 'Cadastro de Usuarios',
'Cadastro Estados de tickets': 'Cadastro Estados de tickets',
...
'Click on the link %(link)s to reset your password': 'Clique no link %(link)s para resetar a senha',
...
'Confirm Password': 'Comfirmar Senha',
'contains': 'Contem',
...
'db': 'bd',
'DB Model': 'Modelo BD',
'Definir Analista': 'Definir Analista',
'Definições dos tickets': 'Definições dos tickets',
'Delete': 'Delete',
'Delete:': 'Apagar:',
'Demo': 'Demo',
...
'Descrição': 'Descrição',
'Descrição da Area do Ticket': 'Descrição da Area do Ticket',
'Descrição da Urgencia do Ticket': 'Descrição da Urgencia do Ticket',
'Descrição do Estado do Ticket': 'Descrição do Estado do Ticket',
'Descrição do Tipo do Ticket': 'Descrição do Tipo do Ticket',
'design': 'projeto',
'Design': 'Design',
'DISK': 'DISK',
...
'Estado do Ticket': 'Estado do Ticket',
'Estados de tickets': 'Estados de tickets',
'Estados possiveis do Ticket': 'Estados possiveis do Ticket',
...
'Niveis de Urgencia de Ticket': 'Niveis de Urgencia de Ticket',
'Niveis de Urgencia do Ticket': 'Niveis de Urgencia do Ticket',
'Nivel de Urgencia do Ticket': 'Nivel de Urgencia do Ticket',
...
'Telefone': 'Telefone',
'Tempo de Espera Regulamentado (SLA)': 'Tempo de Espera Regulamentado (SLA)',
'teste': 'teste',
...
'Timestamp': 'Timestamp',
'Tipo': 'Tipo',
'Tipo de Ticket': 'Tipo de Ticket',
'Tipo de tickets': 'Tipo de tickets',
'Tipo do Ticket': 'Tipo do Ticket',
'Traceback': 'Traceback',
...
'Update:': 'Atualizar:',
'Urgencia': 'Urgencia',
'Urgencia de tickets': 'Urgencia de tickets',
'Urgencia do Ticket': 'Urgencia do Ticket',
...
'Visualizar todos': 'Visualizar todos',
'Você esta logado com uma conta de Administrador do Sistema': 'Você esta logado com uma conta de Administrador do Sistema',
'Você esta logado com uma conta de Cliente do Sistema': 'Você esta logado com uma conta de Cliente do Sistema',
'Você não tem permissão para alterar este ticket': 'Você não tem permissão para alterar este ticket',
'Web2py': 'Web2py',
'Welcome': 'Bem-vindo',
...
'Welcome to web2py!': 'Bem-vindo ao web2py!',
'Welcome to web2py!Não identificado': 'Welcome to web2py!Não identificado',
